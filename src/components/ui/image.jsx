...
/**
 * Image with built-in Wix Media Platform support: URLs on static.wixstatic.com are served
 * resized to the rendered container (per device pixel ratio) and re-encoded to
 * WebP; `fittingType="fill"` crops server-side, optionally anchored at a focal
